class LeavePage:
    def __init__(self,driver):
        ...
        self.leave_apply_btn = "//*[@id='app']/div[1]/div[1]/header/div[2]/nav/ul/li[1]"
        self.leave_my_leave_btn = "//*[@id='app']/div[1]/div[1]/header/div[2]/nav/ul/li[2]"
    ...
    def click_leave_btn(self):
        ...
        self.driver.find_element_by_xpath(self.leave_apply_btn).click()
        self.driver.find_element_by_xpath(self.leave_my_leave_btn).click()
